...
INSERT INTO City VALUES (1537,'KAUSo','JPN','Kyoto',1461974);
...
INSERT INTO City VALUES (2850,'ChinAUS','PAK','Punjab',169300);
...
-- ============================================
-- SECTION 3: YOUR NEW DATA/RECORDS (MODIFY THIS SECTION)
-- Table names below must match exactly what you defined in create_tables_groupX.sql
-- Add at least 20 rows for each new table.
-- Your data must be spread across 4+ continents.
...
VALUES
    ('ARG', 2020, 144640, 25.32, 67.76, 6.92),
    ('AUS', 2020, 265150, 24.24, 75.76, 0),
    ('BRA', 2020, 628760, 83.17, 14.60, 2.23),
    ('CAN', 2020, 655890, 66.60, 18.54, 14.87),
    ('CHN', 2020, 7778070, 28.09, 67.20, 4.71),
    ('EGY', 2020, 198600, 11.96, 88.04, 0),
    ('FRA', 2020, 527250, 23.71, 9.18, 67.11),
    ('DEU', 2020, 566750, 44.37, 44.27, 11.36),
    ('IND', 2020, 1563430, 19.01, 78.14, 2.85),
    ('IDN', 2020, 291820, 18.12, 81.88, 0),
    ('JPN', 2020, 1011030, 19.09, 76.65, 4.25),
    ('KEN', 2020, 11680, 93.58, 6.42, 0),
    ('MEX', 2020, 325730, 21.30, 75.27, 3.43),
    ('NZL', 2020, 43350, 80.92, 19.08, 0),
    ('NGA', 2020, 38000, 20.55, 79.45, 0),
    ('PER', 2020, 53990, 63.48, 36.52, 0),
    ('ZAF', 2020, 241740, 6.34, 89.54, 4.11),
    ('SWE', 2020, 163780, 68.47, 1.49, 30.04),
    ('GBR', 2020, 310300, 43.06, 40.74, 16.19),
    ('USA', 2020, 4125100, 20.32, 60.15, 19.54);
COMMIT;

START TRANSACTION;
INSERT INTO Climate_Data 
    (country_code, year, avg_temperature, avg_rainfall, co2_emissions, climate_stress_index)
VALUES
('ARG', 2020, 15.2, 591, 4.4, 0.12),
('AUS', 2020, 21.8, 534, 15.2, 1.41),
('BRA', 2020, 24.9, 1761, 2.1, -0.52),
('CAN', 2020, 5.4, 537, 15.5, 0.88),
('CHN', 2020, 7.4, 645, 7.4, 0.22),
('EGY', 2020, 22.1, 51, 2.5, 1.67),
('FRA', 2020, 11.7, 867, 4.6, -0.18),
('DEU', 2020, 10.3, 789, 7.7, 0.03),
('IND', 2020, 24.0, 1083, 1.9, -0.11),
('IDN', 2020, 26.7, 2702, 2.3, -1.02),
('JPN', 2020, 11.5, 1677, 8.5, -0.27),
('KEN', 2020, 23.5, 630, 0.4, 0.44),
('MEX', 2020, 20.6, 758, 3.6, 0.02),
('NZL', 2020, 10.8, 1730, 6.8, -0.33),
('NGA', 2020, 26.0, 1150, 0.7, -0.41),
('PER', 2020, 19.7, 1736, 2.0, -0.48),
('ZAF', 2020, 17.5, 495, 7.5, 0.63),
('SWE', 2020, 6.1, 624, 3.3, -0.09),
('GBR', 2020, 9.3, 1154, 5.2, -0.36),
('USA', 2020, 13.4, 715, 14.2, 0.76);
COMMIT;

START TRANSACTION;
INSERT INTO Education_Indicators
    (country_code, year, literacy_percentage,
     primary_enrollment_pct, secondary_enrollment_pct, education_gdp_pct)
VALUES
    ('ARG', 2020, 99.0, 113.5, 98.2, 5.3),
    ('AUS', 2020, 99.0, 103.1, 122.4, 5.1),
    ('BRA', 2020, 93.2, 98.7, 89.5, 6.1),
    ('CAN', 2020, 99.0, 101.2, 114.3, 5.5),
    ('CHN', 2020, 97.0, 102.5, 94.1, 4.0),
    ('EGY', 2020, 75.7, 106.3, 82.4, 3.8),
    ('FRA', 2020, 99.0, 103.4, 110.2, 5.4),
    ('DEU', 2020, 99.0, 102.8, 109.7, 4.8),
    ('IND', 2020, 74.4, 113.0, 74.1, 3.1),
    ('IDN', 2020, 96.0, 108.2, 89.7, 3.6),
    ('JPN', 2020, 99.0, 101.0, 102.5, 3.2),
    ('KEN', 2020, 81.5, 104.7, 68.3, 5.1),
    ('MEX', 2020, 95.4, 102.1, 92.8, 4.3),
    ('NZL', 2020, 99.0, 103.5, 118.2, 6.0),
    ('NGA', 2020, 62.0, 84.3, 56.2, 1.7),
    ('PER', 2020, 94.5, 104.9, 91.4, 4.2),
    ('ZAF', 2020, 87.0, 98.6, 72.1, 6.2),
    ('SWE', 2020, 99.0, 101.8, 115.4, 6.8),
    ('GBR', 2020, 99.0, 102.7, 112.9, 5.6),
    ('USA', 2020, 99.0, 101.3, 94.6, 5.0);
COMMIT;
